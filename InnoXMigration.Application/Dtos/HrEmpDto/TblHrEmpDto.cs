...
namespace InnoXMigration.Application.Dtos.HrEmpDto
{
    ...
    {
        Name, StaffNo, EmpActive, EmpVisible, Dept, Section, JobTitle, Birthdays, EmpUnit, Grade, Area, Location, Geneder, TelNo, Mobno, Intercom,
        ApprasailGroup, EmailOfficial, EmailPersonal, DoB, HireDate, PromoDate
    }
